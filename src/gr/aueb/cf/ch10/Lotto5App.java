...
public class Lotto5App {
     ...
     *
     *
     * @param arr the input arry
     * @param threshold
     *  the upper limit of the constrait
     *
     * @return
     *  true if the number of even is greater than or equal to threshold, false otherwise
     */
