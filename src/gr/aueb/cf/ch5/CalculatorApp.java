 ...
 * Εμφανίζει ενα μενού προς το χρήστη με επιλογές,
 * λαμβάνει την τιμή της επιλογής και στην συνλεχεια
 * δυο ακόμα τιμές των num1 και num2.
...
public class CalculatorApp {
    ...
    public static void printMenu() {
        System.out.println("Επλιλέξτε ένα απο τα παρακάτω");
